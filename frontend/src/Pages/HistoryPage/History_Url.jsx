...
import { Button, Center, Modal, Stack, Table, TextInput } from '@mantine/core';
...
export const History_Url = () => {
   ...
   const updateRecord = async (shortCode, updatedDataParam) => {
       try {
           const response = await service.patch(`s/${shortCode}`, updatedDataParam);
